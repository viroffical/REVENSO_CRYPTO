        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/75 to-transparent text-white">
          <div className="flex items-center mb-1">
            ...
            <a
              href={
                userProfile.twitter
                  ? `https://x.com/${userProfile.twitter.replace("@", "")}`
                  : "#"
              }
              target="_blank"
          ...
          <div className="flex items-center mb-1">
            ...
            <p className="text-sm font-medium drop-shadow-md">
              {userProfile.profile?.role || "Developer"}{" "}
              {userProfile.profile?.project
                ? `at ${userProfile.profile.project}`
                : ""}
            </p>
          </div>
          ...
          <p className="text-sm text-white mb-2 drop-shadow-md">
            {userProfile.profile?.description
              ? `Looking to meet ${userProfile.profile.description}`
