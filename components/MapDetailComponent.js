  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 relative">
      ...
      <div className="absolute top-0 left-0 right-0 z-10">
        <div className="bg-white bg-opacity-90 backdrop-blur-sm p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <button className="p-2 rounded-full hover:bg-gray-100">
              <FontAwesomeIcon icon={faArrowLeft} className="text-gray-700 h-5 w-5" />
            </button>
            <h1 className="text-lg font-bold">Discover Events</h1>
            <button className="p-2 rounded-full hover:bg-gray-100">
              <FontAwesomeIcon icon={faEllipsisVertical} className="text-gray-700 h-5 w-5" />
            </button>
          </div>
            ...
            <div className="flex">
              <div className="relative flex-grow">
                ...
                <input 
                  ...
                  className="w-full pl-10 py-2 pr-4 bg-gray-100 rounded-l-full border-0 outline-none"
                />
              </div>
              <button className="bg-indigo-600 text-white px-4 rounded-r-full flex items-center justify-center">
          ...
          {/* Category filters */}
          <div className="flex overflow-x-auto py-3 -mx-4 px-4 scrollbar-hide">
            <button 
              className={`flex-shrink-0 px-4 py-1 mr-2 rounded-full text-sm font-medium ${
                activeCategory === 'all' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700'
              }`}
            ...
            <button 
              className={`flex-shrink-0 px-4 py-1 mr-2 rounded-full text-sm font-medium ${
                activeCategory === 'tech' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700'
              }`}
            ...
            <button 
              className={`flex-shrink-0 px-4 py-1 mr-2 rounded-full text-sm font-medium ${
                activeCategory === 'business' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700'
              }`}
            ...
            <button 
              className={`flex-shrink-0 px-4 py-1 mr-2 rounded-full text-sm font-medium ${
                activeCategory === 'education' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700'
              }`}
            ...
            <button 
              className={`flex-shrink-0 px-4 py-1 mr-2 rounded-full text-sm font-medium ${
                activeCategory === 'art' ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700'
              }`}
